Contributing to test Core
============================

The test Core project operates an open contributor model where anyone is
...
The following applies to code changes to the test Core project, and is not to be
confused with overall test Network Protocol consensus changes.

Whether a pull request is merged into test Core rests with the project merge
...
The project leader is the release manager for each test Core release.
