...
For example:
```bash
URL=https://github.com/konez2k/kyd.git
...
[kyd/gitian.sigs](https://github.com/kyd/gitian.sigs/) repository, or if that's not possible to create a pull
request.
