...
In order to support loading of multiple wallets in kyd-qt, a few changes in the UI architecture will be needed.
...
Only requiring some minor changes is kyd.cpp.
...
Changes to kyd.cpp
----------------------
kyd.cpp is the entry point into kyd-qt, and as such, will require some minor modifications to provide hooks for
