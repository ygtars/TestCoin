...
In order to support loading of multiple wallets in test-qt, a few changes in the UI architecture will be needed.
...
Only requiring some minor changes is test.cpp.
...
Changes to test.cpp
----------------------
test.cpp is the entry point into test-qt, and as such, will require some minor modifications to provide hooks for
