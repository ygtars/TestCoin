                                                                            ...
                                                                            spinnerFrame(0)
{
    ...
    QString windowTitle = tr("test Core") + " - ";
#ifdef ENABLE_WALLET
...
void BitcoinGUI::createActions(const NetworkStyle* networkStyle)
{
    ...
    privacyAction->setStatusTip(tr("Privacy Actions for ztst"));
    ...
    aboutAction = new QAction(networkStyle->getAppIcon(), tr("&About test Core"), this);
    aboutAction->setStatusTip(tr("Show information about test Core"));
    ...
    showHelpMessageAction->setStatusTip(tr("Show the test Core help message to get a list with possible test command-line options"));
...
void BitcoinGUI::createTrayIcon(const NetworkStyle* networkStyle)
{
    ...
    QString toolTip = tr("test Core client") + " " + networkStyle->getTitleAddText();
...
{
    QString strTitle = tr("test Core"); // default title
