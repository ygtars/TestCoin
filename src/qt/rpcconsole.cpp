                                          ...
                                          banTableContextMenu(0)
{
    ...
    std::string strztstPathCustom = GetArg("-ztstbackuppath", "");
    ...
    if(!strztstPathCustom.empty()) {
        ui->wallet_customztstbackuppath->setText(QString::fromStdString(strztstPathCustom));
        ui->wallet_customztstbackuppath_label->setVisible(true);
        ui->wallet_customztstbackuppath->setVisible(true);
    }

    if((!strPathCustom.empty() || !strztstPathCustom.empty()) && nCustomBackupThreshold > 0) {
