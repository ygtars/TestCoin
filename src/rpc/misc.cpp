...
UniValue getinfo(const UniValue& params, bool fHelp)
{
    if (fHelp || params.size() != 0)
        throw runtime_error(
            ...
            "  \"balance\": xxxxxxx,         (numeric) the total test balance of the wallet (excluding zerocoins)\n"
            ...
            "  \"ztstsupply\" :\n"
            "  {\n"
            "     \"1\" : n,            (numeric) supply of 1 ztst denomination\n"
            "     \"5\" : n,            (numeric) supply of 5 ztst denomination\n"
            "     \"10\" : n,           (numeric) supply of 10 ztst denomination\n"
            "     \"50\" : n,           (numeric) supply of 50 ztst denomination\n"
            "     \"100\" : n,          (numeric) supply of 100 ztst denomination\n"
            "     \"500\" : n,          (numeric) supply of 500 ztst denomination\n"
            "     \"1000\" : n,         (numeric) supply of 1000 ztst denomination\n"
            "     \"5000\" : n,         (numeric) supply of 5000 ztst denomination\n"
            "     \"total\" : n,        (numeric) The total supply of all ztst denominations\n"
            "  }\n"
    ...
    UniValue ztstObj(UniValue::VOBJ);
    for (auto denom : libzerocoin::zerocoinDenomList) {
        ztstObj.push_back(Pair(to_string(denom), ValueFromAmount(chainActive.Tip()->mapZerocoinSupply.at(denom) * (denom*COIN))));
    }
    ztstObj.push_back(Pair("total", ValueFromAmount(chainActive.Tip()->GetZerocoinSupply())));
    obj.push_back(Pair("ztstsupply", ztstObj));
