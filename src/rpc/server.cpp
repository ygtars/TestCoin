...
static const CRPCCommand vRPCCommands[] =
    {
        ...
        {"test", "createmasternodebroadcast", &createmasternodebroadcast, true, true, false},
        {"test", "decodemasternodebroadcast", &decodemasternodebroadcast, true, true, false},
        {"test", "relaymasternodebroadcast", &relaymasternodebroadcast, true, true, false},
        ...
        {"zerocoin", "getztstseed", &getztstseed, false, false, true},
        {"zerocoin", "setztstseed", &setztstseed, false, false, true},
        {"zerocoin", "generatemintlist", &generatemintlist, false, false, true},
        {"zerocoin", "searchdztst", &searchdztst, false, false, true},
        {"zerocoin", "dztststate", &dztststate, false, false, true}
