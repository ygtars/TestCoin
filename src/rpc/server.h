...
extern UniValue setztstseed(const UniValue& params, bool fHelp);
extern UniValue getztstseed(const UniValue& params, bool fHelp);
extern UniValue generatemintlist(const UniValue& params, bool fHelp);
extern UniValue searchdztst(const UniValue& params, bool fHelp);
extern UniValue dztststate(const UniValue& params, bool fHelp);
